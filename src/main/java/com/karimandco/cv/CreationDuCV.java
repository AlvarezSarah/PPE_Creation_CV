...
public class CreationDuCV extends javax.swing.JPanel {
    ...
    public CreationDuCV(Integer idCV, Integer idUtilisateur) {
        initComponents();
        this.idUtilisateur = Utilisateur.getInstance().getId();
        this.idCV = idCV;
    ...
    private void initComponents() {
        ...
        jTabbedPaneFormation.addTab("Formation", formation1);

        jLabel4.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("Vos exprérience professionnel");

        jTabbedPaneExperiencePro.addTab("Expérience pro", experiencePro1);
